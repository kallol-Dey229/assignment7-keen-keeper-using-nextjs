        ...
        <div className="grid grid-cols-3 mt-20 gap-10 mx-65 h-full">
            ...
            <div className="grid grid-cols-3 gap-3">
                <div className="bg-base-100 shadow-sm p-5 text-center">
                    <h2 className="font-bold text-green-950 text-2xl">62</h2>
                    <p>Days Since Contact</p>
                </div>
                <div className="bg-base-100 shadow-sm p-5 text-center">
                    <h2 className="font-bold text-green-950 text-2xl">30</h2>
                    <p>Goal(Days)</p>
                </div>
                <div className="bg-base-100 shadow-sm p-5 text-center">
                    <h2 className="font-bold text-green-950 text-2xl">Feb 27, 2026</h2>
                    <p>Next Due</p>
                </div>
            </div>
